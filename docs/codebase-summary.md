...
- The shared shell header now shows `Rerolls X/Y  Gen MM:SS` in the top-right corner, and the TUI runtime redraws once per second so refill countdowns keep ticking even without input.
